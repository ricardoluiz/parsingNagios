...
public class HostStatusVO extends BaseVO {
	...
	private String last_time_down;
	private String last_time_unreachable;
	...
	private String obsess_over_host;
	...
	public void setLast_time_up(String last_time_up) {
		this.last_time_up = last_time_up;
	}
	public String getLast_time_down() {
		return last_time_down;
	}
	public void setLast_time_down(String last_time_down) {
		this.last_time_down = last_time_down;
	}
	public String getLast_time_unreachable() {
		return last_time_unreachable;
	}
	public void setLast_time_unreachable(String last_time_unreachable) {
	...
	public String getObsess_over_host() {
		return obsess_over_host;
	}
	public void setObsess_over_host(String obsess_over_host) {
